...
let CompareTypes = [
    ...
    {type: 'text', name: 'contains', id: 104, fields: 1},

    {type: 'date', name: 'before', id: 201, fields: 1},
    {type: 'date', name: 'after', id: 202, fields: 1},
    {type: 'date', name: 'between', id: 203, fields: 2},
